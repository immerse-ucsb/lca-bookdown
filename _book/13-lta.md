...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-3adfa67ba1f925db8c48" style="width:672px;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-3adfa67ba1f925db8c48">{"x":{"diagram":" digraph model {\n\n    graph [layout = dot, overlap = true]\n\n    node [shape=box]\n    ab39m ab39t ab39u ab39w ab39x \n    ga33a ga33h ga33i ga33k ga33l;\n \n \n    node [shape=circle, fixedsize = true, width = 1.5, height = 0.5]\n    T1 [label = \"7th Grade \nScience Attitudes\n(T1)\"]\n    T2 [label = \"10th Grade \nScience Attitudes\n(T2)\"]\n    \n    edge []\n    T1 -> {ab39m ab39t ab39u ab39w ab39x}\n    T2 -> {ga33a ga33h ga33i ga33k ga33l}\n    T1 -> T2\n    {rank = same; T1; T2;}\n }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
<!-- preamble start -->
    ...
    <script>
      ...
      function styleCell_r0xxxp4y2jql7hgkt3qr(i, j, css_id) {
          var table = document.getElementById("tinytable_r0xxxp4y2jql7hgkt3qr");
      ...
      function spanCell_r0xxxp4y2jql7hgkt3qr(i, j, rowspan, colspan) {
        var table = document.getElementById("tinytable_r0xxxp4y2jql7hgkt3qr");
      ...
      window.addEventListener('load', function () {
          ...
          { positions: [ { i: 12, j: 1 }, { i: 12, j: 2 }, { i: 12, j: 3 }, { i: 12, j: 4 }, { i: 12, j: 5 }, { i: 12, j: 6 },  ], css_id: 'tinytable_css_pscg8wx4nmhscbv4px8v',}, 
          { positions: [ { i: 2, j: 1 }, { i: 3, j: 1 }, { i: 4, j: 1 }, { i: 1, j: 1 }, { i: 6, j: 1 }, { i: 7, j: 1 }, { i: 8, j: 1 }, { i: 5, j: 1 }, { i: 10, j: 1 }, { i: 11, j: 1 }, { i: 3, j: 2 }, { i: 9, j: 1 }, { i: 1, j: 2 }, { i: 2, j: 2 }, { i: 7, j: 2 }, { i: 4, j: 2 }, { i: 5, j: 2 }, { i: 6, j: 2 }, { i: 11, j: 2 }, { i: 8, j: 2 }, { i: 9, j: 2 }, { i: 10, j: 2 }, { i: 2, j: 3 }, { i: 3, j: 3 }, { i: 4, j: 3 }, { i: 1, j: 3 }, { i: 6, j: 3 }, { i: 7, j: 3 }, { i: 8, j: 3 }, { i: 5, j: 3 }, { i: 10, j: 3 }, { i: 11, j: 3 }, { i: 3, j: 4 }, { i: 9, j: 3 }, { i: 1, j: 4 }, { i: 2, j: 4 }, { i: 7, j: 4 }, { i: 4, j: 4 }, { i: 5, j: 4 }, { i: 6, j: 4 }, { i: 11, j: 4 }, { i: 8, j: 4 }, { i: 9, j: 4 }, { i: 10, j: 4 }, { i: 2, j: 5 }, { i: 3, j: 5 }, { i: 4, j: 5 }, { i: 1, j: 5 }, { i: 6, j: 5 }, { i: 7, j: 5 }, { i: 8, j: 5 }, { i: 5, j: 5 }, { i: 10, j: 5 }, { i: 11, j: 5 }, { i: 3, j: 6 }, { i: 9, j: 5 }, { i: 1, j: 6 }, { i: 2, j: 6 }, { i: 7, j: 6 }, { i: 4, j: 6 }, { i: 5, j: 6 }, { i: 6, j: 6 }, { i: 11, j: 6 }, { i: 8, j: 6 }, { i: 9, j: 6 }, { i: 10, j: 6 },  ], css_id: 'tinytable_css_ffdncadu8ku47ibyex6o',}, 
          { positions: [ { i: 0, j: 1 }, { i: 0, j: 2 }, { i: 0, j: 3 }, { i: 0, j: 4 }, { i: 0, j: 5 }, { i: 0, j: 6 },  ], css_id: 'tinytable_css_o3gx708udf5lm8ooix5i',}, 
          { positions: [ { i: 12, j: 0 },  ], css_id: 'tinytable_css_xggfi1j9ufiozusp5l2z',}, 
          { positions: [ { i: 1, j: 0 }, { i: 2, j: 0 }, { i: 3, j: 0 }, { i: 4, j: 0 }, { i: 5, j: 0 }, { i: 6, j: 0 }, { i: 7, j: 0 }, { i: 8, j: 0 }, { i: 9, j: 0 }, { i: 10, j: 0 }, { i: 11, j: 0 },  ], css_id: 'tinytable_css_rwzpxuq63tdxjhvarmja',}, 
          { positions: [ { i: 0, j: 0 },  ], css_id: 'tinytable_css_63dh9p8foylrz0ywa1zc',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  styleCell_r0xxxp4y2jql7hgkt3qr(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
      ...
      .table td.tinytable_css_pscg8wx4nmhscbv4px8v, .table th.tinytable_css_pscg8wx4nmhscbv4px8v { text-align: right; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_ffdncadu8ku47ibyex6o, .table th.tinytable_css_ffdncadu8ku47ibyex6o { text-align: right; }
      .table td.tinytable_css_o3gx708udf5lm8ooix5i, .table th.tinytable_css_o3gx708udf5lm8ooix5i { text-align: right; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
      .table td.tinytable_css_xggfi1j9ufiozusp5l2z, .table th.tinytable_css_xggfi1j9ufiozusp5l2z { text-align: left; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_rwzpxuq63tdxjhvarmja, .table th.tinytable_css_rwzpxuq63tdxjhvarmja { text-align: left; }
      .table td.tinytable_css_63dh9p8foylrz0ywa1zc, .table th.tinytable_css_63dh9p8foylrz0ywa1zc { text-align: left; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
    </style>
    <div class="container">
      <table class="table table-borderless" id="tinytable_r0xxxp4y2jql7hgkt3qr" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
        <thead>
...
<!-- preamble start -->
    ...
    <script>
      ...
      function styleCell_g2jie4k6x0rrp1k6uv25(i, j, css_id) {
          var table = document.getElementById("tinytable_g2jie4k6x0rrp1k6uv25");
          var cell = table.rows[i]?.cells[j];  // Safe navigation to avoid errors
          if (cell) {
              console.log(`Styling cell at (${i}, ${j}) with class ${css_id}`);
              cell.classList.add(css_id);
      ...
      function spanCell_g2jie4k6x0rrp1k6uv25(i, j, rowspan, colspan) {
        var table = document.getElementById("tinytable_g2jie4k6x0rrp1k6uv25");
        const targetRow = table.rows[i];
        const targetCell = targetRow.cells[j];
        for (let r = 0; r < rowspan; r++) {
    ...
    <style>
      /* tinytable css entries after */
      .table td.tinytable_css_z5v6iom0iqnhb1kz9cpo, .table th.tinytable_css_z5v6iom0iqnhb1kz9cpo { text-align: right; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_0tt07cqsn6yzzkv1abcn, .table th.tinytable_css_0tt07cqsn6yzzkv1abcn { text-align: right; }
      .table td.tinytable_css_7thzoe70spiagdhljvcc, .table th.tinytable_css_7thzoe70spiagdhljvcc { text-align: right; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
      .table td.tinytable_css_mkhfcxylj51f5wojp26g, .table th.tinytable_css_mkhfcxylj51f5wojp26g { text-align: left; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_zg5xq9uky971ddjjnqba, .table th.tinytable_css_zg5xq9uky971ddjjnqba { text-align: left; }
      .table td.tinytable_css_i8bdrc143gguid4ok94r, .table th.tinytable_css_i8bdrc143gguid4ok94r { text-align: left; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
    </style>
    <div class="container">
      <table class="table table-borderless" id="tinytable_g2jie4k6x0rrp1k6uv25" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
        <thead>
...
```{=html}
<div id="chparcdaco" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#chparcdaco table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#chparcdaco thead, #chparcdaco tbody, #chparcdaco tfoot, #chparcdaco tr, #chparcdaco td, #chparcdaco th {
  border-style: none;
}
...
#chparcdaco .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#chparcdaco .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#chparcdaco .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#chparcdaco .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#chparcdaco .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#chparcdaco .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#chparcdaco .gt_spanner_row {
  border-bottom-style: hidden;
}

#chparcdaco .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#chparcdaco .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#chparcdaco .gt_from_md > :first-child {
  margin-top: 0;
}

#chparcdaco .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#chparcdaco .gt_row_group_first td {
  border-top-width: 2px;
}

#chparcdaco .gt_row_group_first th {
  border-top-width: 2px;
}

#chparcdaco .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#chparcdaco .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#chparcdaco .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#chparcdaco .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#chparcdaco .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#chparcdaco .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#chparcdaco .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#chparcdaco .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#chparcdaco .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#chparcdaco .gt_font_normal {
  font-weight: normal;
}

#chparcdaco .gt_font_bold {
  font-weight: bold;
}

#chparcdaco .gt_font_italic {
  font-style: italic;
}
...
#chparcdaco .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#chparcdaco .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#chparcdaco .gt_indent_1 {
  text-indent: 5px;
}

#chparcdaco .gt_indent_2 {
  text-indent: 10px;
}

#chparcdaco .gt_indent_3 {
  text-indent: 15px;
}

#chparcdaco .gt_indent_4 {
  text-indent: 20px;
}

#chparcdaco .gt_indent_5 {
  text-indent: 25px;
}

#chparcdaco .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#chparcdaco div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
```{=html}
<div id="dzgcwxvutw" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#dzgcwxvutw table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#dzgcwxvutw thead, #dzgcwxvutw tbody, #dzgcwxvutw tfoot, #dzgcwxvutw tr, #dzgcwxvutw td, #dzgcwxvutw th {
  border-style: none;
}
...
#dzgcwxvutw .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#dzgcwxvutw .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#dzgcwxvutw .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#dzgcwxvutw .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#dzgcwxvutw .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#dzgcwxvutw .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#dzgcwxvutw .gt_spanner_row {
  border-bottom-style: hidden;
}

#dzgcwxvutw .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dzgcwxvutw .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#dzgcwxvutw .gt_from_md > :first-child {
  margin-top: 0;
}

#dzgcwxvutw .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#dzgcwxvutw .gt_row_group_first td {
  border-top-width: 2px;
}

#dzgcwxvutw .gt_row_group_first th {
  border-top-width: 2px;
}

#dzgcwxvutw .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#dzgcwxvutw .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#dzgcwxvutw .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#dzgcwxvutw .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dzgcwxvutw .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#dzgcwxvutw .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dzgcwxvutw .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dzgcwxvutw .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#dzgcwxvutw .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#dzgcwxvutw .gt_font_normal {
  font-weight: normal;
}

#dzgcwxvutw .gt_font_bold {
  font-weight: bold;
}

#dzgcwxvutw .gt_font_italic {
  font-style: italic;
}
...
#dzgcwxvutw .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#dzgcwxvutw .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#dzgcwxvutw .gt_indent_1 {
  text-indent: 5px;
}

#dzgcwxvutw .gt_indent_2 {
  text-indent: 10px;
}

#dzgcwxvutw .gt_indent_3 {
  text-indent: 15px;
}

#dzgcwxvutw .gt_indent_4 {
  text-indent: 20px;
}

#dzgcwxvutw .gt_indent_5 {
  text-indent: 25px;
}

#dzgcwxvutw .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#dzgcwxvutw div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
