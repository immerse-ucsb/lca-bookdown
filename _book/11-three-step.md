...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-1882a79dfebddef5e205" style="width:672px;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-1882a79dfebddef5e205">{"x":{"diagram":" digraph lca_model {\n\n# The `graph` statement - No editing needed\n\n    graph [layout = dot, overlap = true]\n \n# Two `node` statements\n \n# One for measured variables (box) \n\n    node [shape=box]\n    Enjoy Useful Logical Job Adult Female MothEd MathScore;\n \n# One for latent variables (circle) \n \n    node [shape=circle]\n    science [label=<Science <br/>Attitudes <br/>C<sub>k=4<\/sub>>];\n    \n# `edge` statements\n \n    edge [minlen = 2]\n    science -> {Enjoy Useful Logical Job Adult}\n    science -> MathScore [minlen = 4];\n    Female  -> science [minlen = 4];\n    Female  -> MathScore [minlen = 4];\n    MothEd -> science [minlen = 4];\n    MothEd -> MathScore [minlen = 4];\n    \n {rank = same; science; Female; MothEd; MathScore}\n \n }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
```{=html}
<div id="hdbgugztyu" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#hdbgugztyu table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#hdbgugztyu thead, #hdbgugztyu tbody, #hdbgugztyu tfoot, #hdbgugztyu tr, #hdbgugztyu td, #hdbgugztyu th {
  border-style: none;
}
...
#hdbgugztyu .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#hdbgugztyu .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#hdbgugztyu .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#hdbgugztyu .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#hdbgugztyu .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#hdbgugztyu .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#hdbgugztyu .gt_spanner_row {
  border-bottom-style: hidden;
}

#hdbgugztyu .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hdbgugztyu .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#hdbgugztyu .gt_from_md > :first-child {
  margin-top: 0;
}

#hdbgugztyu .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#hdbgugztyu .gt_row_group_first td {
  border-top-width: 2px;
}

#hdbgugztyu .gt_row_group_first th {
  border-top-width: 2px;
}

#hdbgugztyu .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#hdbgugztyu .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#hdbgugztyu .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#hdbgugztyu .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hdbgugztyu .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#hdbgugztyu .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hdbgugztyu .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hdbgugztyu .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#hdbgugztyu .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#hdbgugztyu .gt_font_normal {
  font-weight: normal;
}

#hdbgugztyu .gt_font_bold {
  font-weight: bold;
}

#hdbgugztyu .gt_font_italic {
  font-style: italic;
}
...
#hdbgugztyu .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#hdbgugztyu .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#hdbgugztyu .gt_indent_1 {
  text-indent: 5px;
}

#hdbgugztyu .gt_indent_2 {
  text-indent: 10px;
}

#hdbgugztyu .gt_indent_3 {
  text-indent: 15px;
}

#hdbgugztyu .gt_indent_4 {
  text-indent: 20px;
}

#hdbgugztyu .gt_indent_5 {
  text-indent: 25px;
}

#hdbgugztyu .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#hdbgugztyu div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
```{=html}
<div id="fcdmmptwdk" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#fcdmmptwdk table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#fcdmmptwdk thead, #fcdmmptwdk tbody, #fcdmmptwdk tfoot, #fcdmmptwdk tr, #fcdmmptwdk td, #fcdmmptwdk th {
  border-style: none;
}
...
#fcdmmptwdk .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#fcdmmptwdk .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#fcdmmptwdk .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#fcdmmptwdk .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#fcdmmptwdk .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#fcdmmptwdk .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#fcdmmptwdk .gt_spanner_row {
  border-bottom-style: hidden;
}

#fcdmmptwdk .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#fcdmmptwdk .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#fcdmmptwdk .gt_from_md > :first-child {
  margin-top: 0;
}

#fcdmmptwdk .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#fcdmmptwdk .gt_row_group_first td {
  border-top-width: 2px;
}

#fcdmmptwdk .gt_row_group_first th {
  border-top-width: 2px;
}

#fcdmmptwdk .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#fcdmmptwdk .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#fcdmmptwdk .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#fcdmmptwdk .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#fcdmmptwdk .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#fcdmmptwdk .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#fcdmmptwdk .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#fcdmmptwdk .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#fcdmmptwdk .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#fcdmmptwdk .gt_font_normal {
  font-weight: normal;
}

#fcdmmptwdk .gt_font_bold {
  font-weight: bold;
}

#fcdmmptwdk .gt_font_italic {
  font-style: italic;
}
...
#fcdmmptwdk .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#fcdmmptwdk .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#fcdmmptwdk .gt_indent_1 {
  text-indent: 5px;
}

#fcdmmptwdk .gt_indent_2 {
  text-indent: 10px;
}

#fcdmmptwdk .gt_indent_3 {
  text-indent: 15px;
}

#fcdmmptwdk .gt_indent_4 {
  text-indent: 20px;
}

#fcdmmptwdk .gt_indent_5 {
  text-indent: 25px;
}

#fcdmmptwdk .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#fcdmmptwdk div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<img src="11-three-step_files/figure-html/unnamed-chunk-10-1.png" width="90%" />
...
```{=html}
<div id="wythsemxcr" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#wythsemxcr table {
  font-family: serif;
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#wythsemxcr thead, #wythsemxcr tbody, #wythsemxcr tfoot, #wythsemxcr tr, #wythsemxcr td, #wythsemxcr th {
  border-style: none;
}
...
#wythsemxcr .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#wythsemxcr .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#wythsemxcr .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#wythsemxcr .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#wythsemxcr .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#wythsemxcr .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#wythsemxcr .gt_spanner_row {
  border-bottom-style: hidden;
}

#wythsemxcr .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wythsemxcr .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#wythsemxcr .gt_from_md > :first-child {
  margin-top: 0;
}

#wythsemxcr .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#wythsemxcr .gt_row_group_first td {
  border-top-width: 2px;
}

#wythsemxcr .gt_row_group_first th {
  border-top-width: 2px;
}

#wythsemxcr .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wythsemxcr .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#wythsemxcr .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#wythsemxcr .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wythsemxcr .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wythsemxcr .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wythsemxcr .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wythsemxcr .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#wythsemxcr .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#wythsemxcr .gt_font_normal {
  font-weight: normal;
}

#wythsemxcr .gt_font_bold {
  font-weight: bold;
}

#wythsemxcr .gt_font_italic {
  font-style: italic;
}
...
#wythsemxcr .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#wythsemxcr .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#wythsemxcr .gt_indent_1 {
  text-indent: 5px;
}

#wythsemxcr .gt_indent_2 {
  text-indent: 10px;
}

#wythsemxcr .gt_indent_3 {
  text-indent: 15px;
}

#wythsemxcr .gt_indent_4 {
  text-indent: 20px;
}

#wythsemxcr .gt_indent_5 {
  text-indent: 25px;
}

#wythsemxcr .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#wythsemxcr div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
```{=html}
<div id="gocozfbkli" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#gocozfbkli table {
  font-family: serif;
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#gocozfbkli thead, #gocozfbkli tbody, #gocozfbkli tfoot, #gocozfbkli tr, #gocozfbkli td, #gocozfbkli th {
  border-style: none;
}
...
#gocozfbkli .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#gocozfbkli .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#gocozfbkli .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#gocozfbkli .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#gocozfbkli .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#gocozfbkli .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#gocozfbkli .gt_spanner_row {
  border-bottom-style: hidden;
}

#gocozfbkli .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#gocozfbkli .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#gocozfbkli .gt_from_md > :first-child {
  margin-top: 0;
}

#gocozfbkli .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#gocozfbkli .gt_row_group_first td {
  border-top-width: 2px;
}

#gocozfbkli .gt_row_group_first th {
  border-top-width: 2px;
}

#gocozfbkli .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#gocozfbkli .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#gocozfbkli .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#gocozfbkli .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#gocozfbkli .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#gocozfbkli .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#gocozfbkli .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#gocozfbkli .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#gocozfbkli .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#gocozfbkli .gt_font_normal {
  font-weight: normal;
}

#gocozfbkli .gt_font_bold {
  font-weight: bold;
}

#gocozfbkli .gt_font_italic {
  font-style: italic;
}
...
#gocozfbkli .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#gocozfbkli .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#gocozfbkli .gt_indent_1 {
  text-indent: 5px;
}

#gocozfbkli .gt_indent_2 {
  text-indent: 10px;
}

#gocozfbkli .gt_indent_3 {
  text-indent: 15px;
}

#gocozfbkli .gt_indent_4 {
  text-indent: 20px;
}

#gocozfbkli .gt_indent_5 {
  text-indent: 25px;
}

#gocozfbkli .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#gocozfbkli div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
<img src="11-three-step_files/figure-html/unnamed-chunk-18-1.png" width="672" />
...
```{=html}
<div id="wtsxqbhagl" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#wtsxqbhagl table {
  font-family: serif;
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#wtsxqbhagl thead, #wtsxqbhagl tbody, #wtsxqbhagl tfoot, #wtsxqbhagl tr, #wtsxqbhagl td, #wtsxqbhagl th {
  border-style: none;
}
...
#wtsxqbhagl .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#wtsxqbhagl .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#wtsxqbhagl .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#wtsxqbhagl .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#wtsxqbhagl .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#wtsxqbhagl .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#wtsxqbhagl .gt_spanner_row {
  border-bottom-style: hidden;
}

#wtsxqbhagl .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wtsxqbhagl .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#wtsxqbhagl .gt_from_md > :first-child {
  margin-top: 0;
}

#wtsxqbhagl .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#wtsxqbhagl .gt_row_group_first td {
  border-top-width: 2px;
}

#wtsxqbhagl .gt_row_group_first th {
  border-top-width: 2px;
}

#wtsxqbhagl .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wtsxqbhagl .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#wtsxqbhagl .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#wtsxqbhagl .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wtsxqbhagl .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wtsxqbhagl .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wtsxqbhagl .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wtsxqbhagl .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#wtsxqbhagl .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#wtsxqbhagl .gt_font_normal {
  font-weight: normal;
}

#wtsxqbhagl .gt_font_bold {
  font-weight: bold;
}

#wtsxqbhagl .gt_font_italic {
  font-style: italic;
}
...
#wtsxqbhagl .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#wtsxqbhagl .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#wtsxqbhagl .gt_indent_1 {
  text-indent: 5px;
}

#wtsxqbhagl .gt_indent_2 {
  text-indent: 10px;
}

#wtsxqbhagl .gt_indent_3 {
  text-indent: 15px;
}

#wtsxqbhagl .gt_indent_4 {
  text-indent: 20px;
}

#wtsxqbhagl .gt_indent_5 {
  text-indent: 25px;
}

#wtsxqbhagl .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#wtsxqbhagl div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
```{=html}
<div id="paqvyqfrbs" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#paqvyqfrbs table {
  font-family: serif;
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#paqvyqfrbs thead, #paqvyqfrbs tbody, #paqvyqfrbs tfoot, #paqvyqfrbs tr, #paqvyqfrbs td, #paqvyqfrbs th {
  border-style: none;
}
...
#paqvyqfrbs .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#paqvyqfrbs .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#paqvyqfrbs .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#paqvyqfrbs .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#paqvyqfrbs .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#paqvyqfrbs .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#paqvyqfrbs .gt_spanner_row {
  border-bottom-style: hidden;
}

#paqvyqfrbs .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#paqvyqfrbs .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#paqvyqfrbs .gt_from_md > :first-child {
  margin-top: 0;
}

#paqvyqfrbs .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#paqvyqfrbs .gt_row_group_first td {
  border-top-width: 2px;
}

#paqvyqfrbs .gt_row_group_first th {
  border-top-width: 2px;
}

#paqvyqfrbs .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#paqvyqfrbs .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#paqvyqfrbs .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#paqvyqfrbs .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#paqvyqfrbs .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#paqvyqfrbs .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#paqvyqfrbs .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#paqvyqfrbs .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#paqvyqfrbs .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#paqvyqfrbs .gt_font_normal {
  font-weight: normal;
}

#paqvyqfrbs .gt_font_bold {
  font-weight: bold;
}

#paqvyqfrbs .gt_font_italic {
  font-style: italic;
}
...
#paqvyqfrbs .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#paqvyqfrbs .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#paqvyqfrbs .gt_indent_1 {
  text-indent: 5px;
}

#paqvyqfrbs .gt_indent_2 {
  text-indent: 10px;
}

#paqvyqfrbs .gt_indent_3 {
  text-indent: 15px;
}

#paqvyqfrbs .gt_indent_4 {
  text-indent: 20px;
}

#paqvyqfrbs .gt_indent_5 {
  text-indent: 25px;
}

#paqvyqfrbs .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#paqvyqfrbs div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
