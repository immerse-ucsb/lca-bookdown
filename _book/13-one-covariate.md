...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-e20ba1d32baeb92f599c" style="width:672px;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-e20ba1d32baeb92f599c">{"x":{"diagram":" digraph lca_model {\n\n# The `graph` statement - No editing needed\n\n    graph [layout = dot, overlap = true]\n \n# Two `node` statements\n \n# One for measured variables (box) \n\n    node [shape=box]\n    Enjoy Useful Logical Job Adult MothEd;\n \n# One for latent variables (circle) \n \n    node [shape=circle]\n    math [label=<Math <br/>Attitudes <br/>C<sub>k=4<\/sub>>];\n    \n# `edge` statements\n \n    edge [minlen = 2]\n    math -> {Enjoy Useful Logical Job Adult}\n    MothEd -> math [minlen = 4];\n    \n {rank = same; math; MothEd;}\n \n }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
```{=html}
<div id="hedbqtzzcc" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#hedbqtzzcc table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#hedbqtzzcc thead, #hedbqtzzcc tbody, #hedbqtzzcc tfoot, #hedbqtzzcc tr, #hedbqtzzcc td, #hedbqtzzcc th {
  border-style: none;
}
...
#hedbqtzzcc .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#hedbqtzzcc .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#hedbqtzzcc .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#hedbqtzzcc .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#hedbqtzzcc .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#hedbqtzzcc .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#hedbqtzzcc .gt_spanner_row {
  border-bottom-style: hidden;
}

#hedbqtzzcc .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hedbqtzzcc .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#hedbqtzzcc .gt_from_md > :first-child {
  margin-top: 0;
}

#hedbqtzzcc .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#hedbqtzzcc .gt_row_group_first td {
  border-top-width: 2px;
}

#hedbqtzzcc .gt_row_group_first th {
  border-top-width: 2px;
}

#hedbqtzzcc .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#hedbqtzzcc .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#hedbqtzzcc .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#hedbqtzzcc .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hedbqtzzcc .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#hedbqtzzcc .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hedbqtzzcc .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#hedbqtzzcc .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#hedbqtzzcc .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#hedbqtzzcc .gt_font_normal {
  font-weight: normal;
}

#hedbqtzzcc .gt_font_bold {
  font-weight: bold;
}

#hedbqtzzcc .gt_font_italic {
  font-style: italic;
}
...
#hedbqtzzcc .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#hedbqtzzcc .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#hedbqtzzcc .gt_indent_1 {
  text-indent: 5px;
}

#hedbqtzzcc .gt_indent_2 {
  text-indent: 10px;
}

#hedbqtzzcc .gt_indent_3 {
  text-indent: 15px;
}

#hedbqtzzcc .gt_indent_4 {
  text-indent: 20px;
}

#hedbqtzzcc .gt_indent_5 {
  text-indent: 25px;
}

#hedbqtzzcc .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#hedbqtzzcc div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
```{=html}
<div id="unyiaowbaq" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#unyiaowbaq table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#unyiaowbaq thead, #unyiaowbaq tbody, #unyiaowbaq tfoot, #unyiaowbaq tr, #unyiaowbaq td, #unyiaowbaq th {
  border-style: none;
}
...
#unyiaowbaq .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#unyiaowbaq .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#unyiaowbaq .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#unyiaowbaq .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#unyiaowbaq .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#unyiaowbaq .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#unyiaowbaq .gt_spanner_row {
  border-bottom-style: hidden;
}

#unyiaowbaq .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#unyiaowbaq .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#unyiaowbaq .gt_from_md > :first-child {
  margin-top: 0;
}

#unyiaowbaq .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#unyiaowbaq .gt_row_group_first td {
  border-top-width: 2px;
}

#unyiaowbaq .gt_row_group_first th {
  border-top-width: 2px;
}

#unyiaowbaq .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#unyiaowbaq .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#unyiaowbaq .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#unyiaowbaq .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#unyiaowbaq .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#unyiaowbaq .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#unyiaowbaq .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#unyiaowbaq .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#unyiaowbaq .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#unyiaowbaq .gt_font_normal {
  font-weight: normal;
}

#unyiaowbaq .gt_font_bold {
  font-weight: bold;
}

#unyiaowbaq .gt_font_italic {
  font-style: italic;
}
...
#unyiaowbaq .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#unyiaowbaq .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#unyiaowbaq .gt_indent_1 {
  text-indent: 5px;
}

#unyiaowbaq .gt_indent_2 {
  text-indent: 10px;
}

#unyiaowbaq .gt_indent_3 {
  text-indent: 15px;
}

#unyiaowbaq .gt_indent_4 {
  text-indent: 20px;
}

#unyiaowbaq .gt_indent_5 {
  text-indent: 25px;
}

#unyiaowbaq .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#unyiaowbaq div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-2db1f04a476d67129e9d" style="width:672px;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-2db1f04a476d67129e9d">{"x":{"diagram":" digraph cfa_model {\n\n# The `graph` statement - No editing needed\n\n    graph [layout = dot, overlap = true]\n \n# Two `node` statements\n \n# One for measured variables (box) \n\n    node [shape=box]\n    GPA LieExam LiePaper Fraud CopyExam;\n \n# One for latent variables (circle) \n \n    node [shape=circle]\n    bully [label=<Cheating <br/>Behavior <br/>C<sub>k=2<\/sub>>];\n    \n# `edge` statements\n \n    edge [minlen = 2]\n    bully -> {LieExam LiePaper Fraud CopyExam}\n    GPA -> bully [minlen = 4];\n    \n {rank = same; bully; GPA}\n \n }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
