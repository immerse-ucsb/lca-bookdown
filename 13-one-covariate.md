...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-8d1b05611cf8fc9555bb" style="width:672px;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-8d1b05611cf8fc9555bb">{"x":{"diagram":" digraph lca_model {\n\n# The `graph` statement - No editing needed\n\n    graph [layout = dot, overlap = true]\n \n# Two `node` statements\n \n# One for measured variables (box) \n\n    node [shape=box]\n    Enjoy Useful Logical Job Adult MothEd;\n \n# One for latent variables (circle) \n \n    node [shape=circle]\n    math [label=<Math <br/>Attitudes <br/>C<sub>k=4<\/sub>>];\n    \n# `edge` statements\n \n    edge [minlen = 2]\n    math -> {Enjoy Useful Logical Job Adult}\n    MothEd -> math [minlen = 4];\n    \n {rank = same; math; MothEd;}\n \n }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
```{=html}
<div id="tbqcqempbn" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#tbqcqempbn table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#tbqcqempbn thead, #tbqcqempbn tbody, #tbqcqempbn tfoot, #tbqcqempbn tr, #tbqcqempbn td, #tbqcqempbn th {
  border-style: none;
}
...
#tbqcqempbn .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#tbqcqempbn .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#tbqcqempbn .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#tbqcqempbn .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#tbqcqempbn .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#tbqcqempbn .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#tbqcqempbn .gt_spanner_row {
  border-bottom-style: hidden;
}

#tbqcqempbn .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#tbqcqempbn .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#tbqcqempbn .gt_from_md > :first-child {
  margin-top: 0;
}

#tbqcqempbn .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#tbqcqempbn .gt_row_group_first td {
  border-top-width: 2px;
}

#tbqcqempbn .gt_row_group_first th {
  border-top-width: 2px;
}

#tbqcqempbn .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#tbqcqempbn .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#tbqcqempbn .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#tbqcqempbn .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#tbqcqempbn .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#tbqcqempbn .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#tbqcqempbn .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#tbqcqempbn .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#tbqcqempbn .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#tbqcqempbn .gt_font_normal {
  font-weight: normal;
}

#tbqcqempbn .gt_font_bold {
  font-weight: bold;
}

#tbqcqempbn .gt_font_italic {
  font-style: italic;
}
...
#tbqcqempbn .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#tbqcqempbn .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#tbqcqempbn .gt_indent_1 {
  text-indent: 5px;
}

#tbqcqempbn .gt_indent_2 {
  text-indent: 10px;
}

#tbqcqempbn .gt_indent_3 {
  text-indent: 15px;
}

#tbqcqempbn .gt_indent_4 {
  text-indent: 20px;
}

#tbqcqempbn .gt_indent_5 {
  text-indent: 25px;
}

#tbqcqempbn .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#tbqcqempbn div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
```{=html}
<div id="kpbxdksemg" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#kpbxdksemg table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#kpbxdksemg thead, #kpbxdksemg tbody, #kpbxdksemg tfoot, #kpbxdksemg tr, #kpbxdksemg td, #kpbxdksemg th {
  border-style: none;
}
...
#kpbxdksemg .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#kpbxdksemg .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#kpbxdksemg .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#kpbxdksemg .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#kpbxdksemg .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#kpbxdksemg .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#kpbxdksemg .gt_spanner_row {
  border-bottom-style: hidden;
}

#kpbxdksemg .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#kpbxdksemg .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#kpbxdksemg .gt_from_md > :first-child {
  margin-top: 0;
}

#kpbxdksemg .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#kpbxdksemg .gt_row_group_first td {
  border-top-width: 2px;
}

#kpbxdksemg .gt_row_group_first th {
  border-top-width: 2px;
}

#kpbxdksemg .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#kpbxdksemg .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#kpbxdksemg .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#kpbxdksemg .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#kpbxdksemg .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#kpbxdksemg .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#kpbxdksemg .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#kpbxdksemg .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#kpbxdksemg .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#kpbxdksemg .gt_font_normal {
  font-weight: normal;
}

#kpbxdksemg .gt_font_bold {
  font-weight: bold;
}

#kpbxdksemg .gt_font_italic {
  font-style: italic;
}
...
#kpbxdksemg .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#kpbxdksemg .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#kpbxdksemg .gt_indent_1 {
  text-indent: 5px;
}

#kpbxdksemg .gt_indent_2 {
  text-indent: 10px;
}

#kpbxdksemg .gt_indent_3 {
  text-indent: 15px;
}

#kpbxdksemg .gt_indent_4 {
  text-indent: 20px;
}

#kpbxdksemg .gt_indent_5 {
  text-indent: 25px;
}

#kpbxdksemg .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#kpbxdksemg div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-207b3bcc00bc2e256d55" style="width:672px;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-207b3bcc00bc2e256d55">{"x":{"diagram":" digraph cfa_model {\n\n# The `graph` statement - No editing needed\n\n    graph [layout = dot, overlap = true]\n \n# Two `node` statements\n \n# One for measured variables (box) \n\n    node [shape=box]\n    GPA LieExam LiePaper Fraud CopyExam;\n \n# One for latent variables (circle) \n \n    node [shape=circle]\n    bully [label=<Cheating <br/>Behavior <br/>C<sub>k=2<\/sub>>];\n    \n# `edge` statements\n \n    edge [minlen = 2]\n    bully -> {LieExam LiePaper Fraud CopyExam}\n    GPA -> bully [minlen = 4];\n    \n {rank = same; bully; GPA}\n \n }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
